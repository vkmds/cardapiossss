...
$afiliado = mysqli_real_escape_string( $db_con, $_GET['afiliado'] );
...
$query .= "SELECT id,nome,perfil,cidade,estado,status,excluded,subdominio,afiliado FROM estabelecimentos ";
							...
							<div class="panel-body">
								...
								<form class="form-filters form-100" method="GET">
									...
									<!--<div class="col-md-4">
											<div class="form-field-default">
												<label>E-mail:</label>
												<input type="text" name="afiliado" placeholder="Afiliado" value="<?php echo htmlclean( $afiliado ); ?>"/>
											</div>
										</div>
									</div>-->
									<div class="row">
					...
					<table class="listing-table fake-table clean-table">
						...
						<tbody>
							...
							<tr>
								...
								<td>
                                    <span class="fake-table-title">Afiliado</span>
                                    <div class="fake-table-data"><?php echo htmlclean( $data['afiliado'] ); ?></div>
                                    <div class="fake-table-break"></div>
								</td>
								<td class="hidden-xs hidden-sm">
